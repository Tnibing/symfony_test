...
class __TwigTemplate_49d11ef5f9b9a15d525241b1f8cee90a extends Template
{
    ...
    <div>
      <img src=\"";
        // line 8
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\HttpFoundationExtension']->generateAbsoluteUrl($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/logo.png")), "html", null, true);
        yield "\"alt=\"\">
      <h2>UF3-Pt2a</h2>
      <hr>
      <h3>Pràctica per iniciar-se en els conceptes bàsics de Symfony-Doctrine</h3>
    </div>
...
";
    ...
    {
        return array (  105 => 8,  100 => 5,  87 => 4,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <div>
      <img src=\"{{ absolute_url(asset ('img/logo.png')) }}\"alt=\"\">
      <h2>UF3-Pt2a</h2>
      <hr>
      <h3>Pràctica per iniciar-se en els conceptes bàsics de Symfony-Doctrine</h3>
    </div>
